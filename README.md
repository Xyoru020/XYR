...
### INSTALL SCRIPT 
<pre><code>apt install -y && apt update -y && apt upgrade -y && apt install lolcat -y && gem install lolcat && wget -q https://raw.githubusercontent.com/Xyoru020/XYR/ABSTRAK/XYR.sh && chmod +x XYR.sh && ./XYR.sh
</code></pre>
